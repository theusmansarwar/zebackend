...
// ✅ Update FAQ
const updatesubFAQ = async (req, res) => {
  try {
    const { id } = req.params;
    let { question, answer } = req.body;
...
// ✅ Delete single FAQ
const deletesubFAQ = async (req, res) => {
  try {
    const { id } = req.params;
...
// ✅ Delete multiple FAQs
const deleteAllsubFAQs = async (req, res) => {
  try {
    const { ids } = req.body;
...
module.exports = { addFAQ, updateFAQ, deleteFAQ, deleteAllFAQs,addsubFAQ, updatesubFAQ, deletesubFAQ, deleteAllsubFAQs };
